// iFt2DHv1.06
#define PLUGIN "iFt2DH Forward FOURIER Transform"
#define AUTHOR "RONC"
#define VER     "1.06<>"
...
#define FORWARD_Transform  false   //FORWARD Ft2DH.8bf
#define INVERSE_Transform  true    //INVERSE iFt2DH.8bf
//********************************************************************************************************
//********************************************************************************************************
...
bool Forward = FORWARD_Transform;//FORWARD Ft2DH.8bf
bool Inverse = INVERSE_Transform;//INVERSE iFt2DH.8bf
                    ...
                    for(k = 0; k < zSize; k++)
                    {
                        for(j = 0; j < ySize; j++)
                        {
                            for(i = 0; i < xSize; i++)
                            {
                                ...
                                if((j % 2) == 1) dSum = -dSum;
                                double_io[xSize * j + i] = dSum;
                            }
                        }
                        //****************************************************
                        // 8 bit Forward   compute forward transform
                        //****************************************************
                        p = fftw_plan_dft_r2c_2d(ySize, xSize, double_io, complex_io, FFTW_ESTIMATE);
                        fftw_execute(p);
                        fftw_destroy_plan(p);
                        //****************************************************
                        ...
                        for(j = 0; j < ySize; j++)
                        {
                            for(i = 0; i < xSizeH; i++)
                            {
                                dAmp = 0.0;
                                dPhz = 0.0;
                                dRe = (double)c_re(complex_io[xSizeH * j + i]);
                                dIm = (double)c_im(complex_io[xSizeH * j + i]);
                    ...
                    for(k = 0; k < zSize; k++)
                    {
                        for(j = 0; j < ySize; j++)
                        {
                            for(i = 0; i < xSizeH; i++)
                            {
                                ...
                                c_re(complex_io[xSizeH * j + i]) = dAmp * cos(dPhz);
                                c_im(complex_io[xSizeH * j + i]) = dAmp * sin(dPhz);
                            }
                        }
                        //****************************************************
                        // 8 bit Inverse    compute inverse transform
                        //****************************************************
                        p = fftw_plan_dft_c2r_2d(ySize, xSize, complex_io, double_io, FFTW_ESTIMATE);
                        fftw_execute(p);
                        fftw_destroy_plan(p);
                        //****************************************************
                        ...
                        for(j = 0; j < ySize; j++)
                        {
                            for(i = 0; i < xSize; i++)
                            {
                                dRe = (double)double_io[xSize * j + i] / xSize_X_ySize;
                ...
                if(Forward == true)
                {
                    ...
                    for(k = 0; k < zSize; k++)
                    {
                        ...
                        for(j = 0; j < ySize; j++)
                        {
                            ...
                            if(xSizeHx2 != xSizeF)
                            {
                                fOut[oRF * j + nPlanes * (xSize - 1) + k] = (float)dRnd;
                            }
                        }
                    }
                }
                    ...
                    for(k = 0; k < zSize; k++)
                    {
                        for(j = 0; j < ySize; j++)
                        {
                            for(i = 0; i < xSizeH; i++)
                            {
                                ...
                                c_re(complex_io[xSizeH * j + i]) = (float)dAmp * cos(dPhz);
                                c_im(complex_io[xSizeH * j + i]) = (float)dAmp * sin(dPhz);
                            }
                        }
                        //****************************************************
