...
#define plugInName            "iFt2DS"
#define plugInCopyrightYear    "2018"
#define    plugInDescription \
"An FFT plug-in for Adobe PhotoshopÆ."
...
#define plugInAETEComment     "iFt2DS plug-in"
...
#include "iFt2DSTerminology.h"    // Terminology for this plug-in.
