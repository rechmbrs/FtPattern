...
<javascriptresource>
<name>Ft2DHA</name>
<about>Fourier_2D_Analysis_for_Photoshop_by_RONC.</about>
<menu>filter</menu>
...
var scriptName = "Fourier_2D_Analysis_for_Photoshop_by_RONC©2018";
...
//*************************************************************************************
var Ft2DH_plugin = "Ft2DH...."; // Must be changed to match plugin if plugin is changed.
...
function Ft2DAnalysis()
{
    ...
    function step03(enabled, withDialog)
    {
        ...
        var dialogMode = (withDialog ? DialogModes.ALL : DialogModes.NO);
        var desc1 = new ActionDescriptor();
        desc1.putString(PSKey.Using, "Ft2DH....");
